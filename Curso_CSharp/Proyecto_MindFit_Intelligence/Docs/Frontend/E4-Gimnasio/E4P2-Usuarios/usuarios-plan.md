...
Desde esta grilla, el usuario debe poder seleccionar un responsable existente.
...
El formulario debe incluir los campos necesarios de datos personales del responsable según el DTO real usado por el backend.
...
Agregar una sección dentro del formulario para cambiar la contraseña del usuario autenticado dentro del sistema.
...
`POST api/Auth/responsables/change-password`
...
* Botón Crear (reemplaza el de Guardar): CREAR_USUARIO_RESPONSABLE
* Botón Guardar (reemplaza el de Crear): EDITAR_USUARIO_RESPONSABLE
* Botón Cambiar Contraseña: CAMBIAR_CONTRASENA_RESPONSABLE
* Botón Eliminar: ELIMINAR_USUARIO_RESPONSABLE_DEFINITIVAMENTE
