...
namespace Backend.Controllers
{
    ...
    public class RandomController : ControllerBase
    {
        ...
        public ActionResult<Dictionary<string, int>> Get()
        {
            ...
            /*
            Singleton: mismo valor en toda la app ⇒ "Singleton 1" y "Singleton 2" serán iguales.
            Scoped: mismo valor durante una misma request ⇒ "Scoped 1" y "Scoped 2" iguales en esa llamada (pero cambiarán en otra llamada).
            Transient: valor nuevo cada vez que se inyecta ⇒ "Transient 1" y "Transient 2" pueden diferir incluso en la misma request. 
            */
