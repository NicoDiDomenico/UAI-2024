...
cadena7 = 'hola'
cadena8 = 'chau'
cadena9 = 'Buenas tardes, soy Nicolás Di Domenico, me duele la pija.'
...
print('REPLACE:')
cadena_nueva = cadena7.replace('hola','Hola liberal libertario anarcocapitalista de feminas') # en este caso es una función
print(cadena7)
print(f'{cadena_nueva}\n') 
...
# propongo hacer un ejercicio que puedas mandar un texto desprolijo y corregirlo. es decir despues de las comas que sean minusculas o que despues de los puntos sean mayusculas
