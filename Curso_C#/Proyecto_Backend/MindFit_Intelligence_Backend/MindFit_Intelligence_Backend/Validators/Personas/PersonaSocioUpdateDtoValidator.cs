...
{
    public class PersonaSocioUpdateDtoValidator : AbstractValidator<PersonaSocioUpdateDto>
    {
        public PersonaSocioUpdateDtoValidator(IValidator<CuotaUpdateDto> cuotaUpdateValidator)
        {
            RuleFor(x => x.Nombre)
            ...
            RuleFor(x => x.Cuota)
                .SetValidator(cuotaUpdateValidator)
                .When(x => x.Cuota != null);
        }
    }
}
