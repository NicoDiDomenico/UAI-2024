...
(1,'2022/07/14',1,1,7500),
(2,'2022/12/02',2,2,3400),
(3,'2012/8/9',83,1,7890.67)
(4,'2013/9/9',13,3,800),
(5,'2015/9/8',113,3,5000.50),
(6,'2015/4/7',3,2,50700),
(7,'2020/5/5',8,1,650)
...
--Exporta el txt
exec xp_cmdshell 'bcp "select uno + dos + tres + cuatro + cinco + seis + siete + ocho FROM FINAL_BDA_CIMARELLI.dbo.comprobantes_txt_export order by uno" queryout "C:\FINAL BDA\Comprobantes_export.txt"  -T -S THINK-FABRI\SQLEXPRESS -c -t'
--------------------------------------------------------------------
...
--ejecuta el proc
exec spu_exportar_comprobantes '2013/01/01','2021/02/02'
