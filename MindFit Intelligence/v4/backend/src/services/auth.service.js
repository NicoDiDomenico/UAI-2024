...
export class AuthService {
    async login(gymId, nombreUsuario, password) {
    ...
    async getUserWithPermissions(usuarioId, gymId) {
        ...
        const permisosFromRoles = usuario.usuarioRoles.flatMap((ur) => ur.rol.rolPermisos.map((rp) => rp.permiso.codigo));
