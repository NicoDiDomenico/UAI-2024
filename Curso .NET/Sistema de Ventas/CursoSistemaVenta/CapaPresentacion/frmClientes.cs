...
namespace CapaPresentacion
{
    public partial class frmClientes : Form
    {
        ...
        {
            // Para el Grid - MOSTRAR TODOS LOS ClienteS
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    int idClienteGenerado = new CN_Cliente().Registrar(unCliente, out mensaje);
                ...
                {
                    bool rta = new CN_Cliente().Editar(unCliente, out mensaje);
