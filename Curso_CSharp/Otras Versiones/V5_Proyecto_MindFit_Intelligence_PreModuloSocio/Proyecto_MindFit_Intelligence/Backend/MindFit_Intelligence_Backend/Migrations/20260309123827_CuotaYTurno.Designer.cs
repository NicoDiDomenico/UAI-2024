...
namespace MindFit_Intelligence_Backend.Migrations
{
    ...
    [Migration("20260309123827_CuotaYTurno")]
    partial class CuotaYTurno
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MindFit_Intelligence_Backend.Models.RangoHorarioResponsable", b =>
                {
                    b.Property<int>("IdRangoHorario")
                        .HasColumnType("int");
                    ...
                    b.HasKey("IdRangoHorario", "IdUsuarioResponsable");

                    b.HasIndex("IdUsuarioResponsable");

                    b.ToTable("RangoHorarioResponsable", (string)null);
                });
            ...
            modelBuilder.Entity("MindFit_Intelligence_Backend.Models.RangoHorarioResponsable", b =>
                {
                    b.HasOne("MindFit_Intelligence_Backend.Models.RangoHorario", "RangoHorario")
                        .WithMany("RangoHorarioResponsables")
                        .HasForeignKey("IdRangoHorario")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("MindFit_Intelligence_Backend.Models.PersonaResponsable", b =>
                {
                    b.Navigation("RangoHorarioResponsables");
