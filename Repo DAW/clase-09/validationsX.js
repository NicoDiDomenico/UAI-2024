...
document.addEventListener("DOMContentLoaded", function() {
    ...
    // Forma 3: function handleLoad() { ... }; document.addEventListener("DOMContentLoaded", handleLoad); // probar ponerle parentesis
    ...
    */
    ...
    function validateForm() {
        ...
        // Muestra un modal con los errores si el formulario no es válido, o un mensaje de éxito si es válido
        if (!isValid) {
    ...
    function showModal(modalId, message) {
        ...
        // Añade el evento de cerrar el modal
...
//Googlear:
// trim() - En JavaScript, el método trim() se utiliza para eliminar los espacios en blanco al principio y al final de una cadena, pero no afecta a los espacios en blanco dentro del texto. Si quieres eliminar los espacios en blanco dentro del texto, puedes usar el método replace() con una expresión regular.