    ...
    public class CD_Proveedor
    {
        public List<Proveedor> Listar()
        {
            ...
            using (SqlConnection oconexion = new SqlConnection(Conexion.cadena))
            {
                ...
                {
                    string query = @"
                        select IdProveedor, Documento, RazonSocial, Correo, Telefono, Estado 
                        from PROVEEDOR
                    ";
        ...
        public int Registrar(Proveedor obj, out string Mensaje)
        {
            ...
            {
                // Si hay un error, se captura la excepción y se devuelve un ID de Proveedor 0 con el mensaje de error
                idProveedorgenerado = 0;
                Mensaje = ex.Message;
            }

            return idProveedorgenerado; // Retorna el ID del Proveedor generado o 0 si hubo error
        }
