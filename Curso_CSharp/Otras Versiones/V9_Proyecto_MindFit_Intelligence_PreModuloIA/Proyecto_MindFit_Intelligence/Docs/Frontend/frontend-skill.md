...
## MindFit Intelligence Frontend Skill

This project is a gym and fitness management platform.
...
Use a restrained and consistent color palette across the entire application.
...
- inconsistent visual themes between screens
- excessive gradients
...
- cohesive visual language across modules

Use the rules below when generating UI, pages, layouts, dashboards, forms, modals, grids, workflows, and visual hierarchy.
