...
// En la documentacion de express como buena práctica es cambiar app por router
/* app = express.Router(); */ // NO VA!!
router = express.Router();

// productos es un arreglo definido en home.js.
// Este arreglo productos sí se "importa" (es decir, se ejecuta como parte del módulo), pero no es directamente accesible desde otros archivos a menos que lo exportes explícitamente. Es decir, las rutas definidas dentro de home.js sí podrán acceder y manipular el arreglo productos sin ningún problema. Aquí está el porqué:
let productos = [
    {
        id: 1,
        name: 'laptop',
