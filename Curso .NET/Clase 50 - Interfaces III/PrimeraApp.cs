...
namespace ProyectoHerencia
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            miWally.Nadar();
            // En C#, un objeto de una clase que implementa una interfaz puede ser asignado a una variable de tipo interfaz
            Caballo miBabieca = new Caballo("Babieca");
            IMamiferosTerrestres ImiBabieca = miBabieca;
            ISaltoConPatas ImiBabieca2 = miBabieca;
            /* miBabieca es un Caballo.
            Pero como Caballo implementa IMamiferosTerrestres, puedes usarlo como si fuera un IMamiferosTerrestres. */

            Console.WriteLine("Número de patas de Babieca: " + ImiBabieca.NumeroPatas());
            Console.WriteLine("Número de patas con los que salta Babieca: " + ImiBabieca2.NumeroPatas());
