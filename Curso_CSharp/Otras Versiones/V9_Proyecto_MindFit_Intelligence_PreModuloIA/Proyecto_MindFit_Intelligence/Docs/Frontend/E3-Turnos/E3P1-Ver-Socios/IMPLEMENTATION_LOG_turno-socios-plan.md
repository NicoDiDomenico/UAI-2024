...
- Ajuste visual: el enlace `Volver a Inicio` de la pagina Ver Socios ahora tiene formato de boton redondeado, una flecha direccional hacia la izquierda y estados de interaccion acordes a la paleta teal existente. Se conservaron su texto, ruta y comportamiento.
